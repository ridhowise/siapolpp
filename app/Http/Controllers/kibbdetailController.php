...
class kibbdetailController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $kibbdetail=kibb::where('tahun_id',$id)->get();
        $total=kibb::where('tahun_id',$id)->sum('harga');

    
        // $total=array_sum($kibbdetail->total);
    
        // dd($kibbdetail);
        
        // foreach($kibbdetail as $kibbdetailz => $barangz ){
        ...
        return view('kibbdetail.index',compact('data','kibbdetail','total'));
    }
