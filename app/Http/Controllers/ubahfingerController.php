...
class ubahfingerController extends Controller
{
    ...
    {
        $data=finger::where('disiplin_id',$id)->get();
        $user=finger::where('disiplin_id',$id)->first();
        ...
        return view('ubahfinger.index',compact('data','user'));
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        $pulangss= $request->input('timep');
            ...
            $fingers=finger::where('disiplin_id',$id)->get();

            foreach($fingers as $key => $finger){
            
            $finger->date = $dates[$key];
