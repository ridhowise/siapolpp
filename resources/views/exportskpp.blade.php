...
<div class="float-right" style="text-align:center;font-size:12px;margin-right:10px">Bitung, 4 Januari 2022 <br><br><b>Pejabat Penilai,</b><br><br><br><br><br><b>{{$atasans}}</b><br><b>{{$atasann->nip}}</b></div><br>
...
<br>
  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size:10px; border : 1px solid black;padding:0px" >
    <tbody style="color:black">
        ...
        <tr>
          <td rowspan="6" style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:5%;background-color:#b8cce4">1</td>
          ...
          <tr>
            ...
            <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$skp->user->name}}</td>
          </tr>
          <tr>
            <td style="font-size:12px; border: 1px solid black;padding:3px;">NIP</td>
            <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
            <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$skp->user->nip}}</td>
          </tr>
          <tr>
            <td style="font-size:12px; border: 1px solid black;padding:3px;">PANGKAT / GOL RUANG</td>
            <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
            <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$skp->user->golongan->name}}</td>
          </tr>
          <tr>
            <td style="font-size:12px; border: 1px solid black;padding:3px;">JABATAN</td>
            <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
            <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$skp->user->level->name}}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td rowspan="6" style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:5%;background-color:#b8cce4">2</td>
            ...
            <tr>
              <td style="font-size:12px; border: 1px solid black;padding:3px;">NAMA</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$atasans}}</td>
            </tr>
            <tr>
              <td style="font-size:12px; border: 1px solid black;padding:3px;">NIP</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$atasann->nip}}</td>
            </tr>
            <tr>
              <td style="font-size:12px; border: 1px solid black;padding:3px;">PANGKAT / GOL RUANG</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$atasann->golongan->name}}</td>
            </tr>
            <tr>
              <td style="font-size:12px; border: 1px solid black;padding:3px;">JABATAN</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px" >{{$atasann->level->name}}</td>
            </tr>
            <tr>
              <td style="font-size:12px; border: 1px solid black;padding:3px;">UNIT KERJA</td>
              <td style="font-size:12px; border: 1px solid black;padding:3px;text-align:center;width:2%">:</td>
