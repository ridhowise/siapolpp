            ...
            <div class="grid">
              ...
              <form action="{{ route('login') }}" method="POST" class="form login">
                ...
                <span class="invalid-feedback" style="text-align: center;"role="alert">
                  <p class="text--center"><strong>{{ $errors->first('email') }}</strong></p>
                </span>
                @endif
                <div class="form__field">
                  ...
                  <input autocomplete="username" id="login__username" type="text" name="email" class="form__input{{ $errors->has('email') ? ' is-invalid' : '' }}"  value="{{ old('email') }}" placeholder="Name" required>
                </div>
                
                @if ($errors->has('password'))
                <span class="invalid-feedback" style="text-align: center;" role="alert">
                  <p class="text--center"><strong>{{ $errors->first('password') }}</strong></p>
                </span>
                  @endif
                <div class="form__field">
