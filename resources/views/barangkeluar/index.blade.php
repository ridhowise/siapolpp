...
<div class="blog-container">
  ...
  <div class="blog-body">
    ...
    <div class="blog-title">
      ...
      {{-- <h1>{{Riskihajar\Terbilang\Facades\Terbilang::make($data->tanggal)}}</h1>
      {{$data->user->name}} --}}
      ...
      <div class="table-responsive">
        <table class="display table table-bordered" id="dataTable" width="100%" cellspacing="0">
         ...
         @foreach($barangkeluar as $key => $items)
              ...
              <tr><td colspan="2"></td><td>TOTAL</td><td><b>{{$total}}</b></td>
              </tr>
          </tbody>
      </table>
    </div>
    ...
    <div class="modal-content" style="border:1px solid black;">
        ...
        <form id="upload-image-form" class="form-horizontal" action=""" method="post"
            ...
            <input type="hidden" name="status" value="1" class="form-control"> 
                                          ...
                                          <tr>
                                          <td> <input type="hidden" readonly name="id[]" placeholder="jumlah" class="form-control" value="{{$items->barang_id}}"> </td>
                                          <td> <input type="hidden" readonly name="jumlah[]" placeholder="jumlah" class="form-control" value="{{$items->keluar}}"> </td>
                                          </tr>
                                          @endforeach
