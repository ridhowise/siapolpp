...
<div class="blog-container container-fluid">
  ...
  <div class="blog-body container-fluid">
    <br>
        ...
        <table class="display table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <thead style="">
            <tr>
              ...
              <th colspan="6" style="text-align:center;">Nomor</th>
              <th rowspan="2">Asal</th>
              <th rowspan="2">Harga</th>
              <th rowspan="2">Keterangan</th>
              <th rowspan="2">File SPJ</th>
              <th rowspan="2">Penunjukan</th>
            </tr>
            <tr>
              <th>Pabrik</th>
              <th>Rangka</th>
          ...
          <tbody>
            ...
            $no = 1;
          @endphp
         @foreach($kibbdetail as $key => $items)
                <td>{{ $no++ }}</td>
                <td>{{ $items->kode }} </td>
                <td>{{ $items->nama }} </td>
