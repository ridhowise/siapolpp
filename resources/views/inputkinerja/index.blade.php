  ...
  <div class="blog-body">
    ...
    <div class="blog-title">
      {{-- <h4>Periode {{$data->awal}} -{{$data->akhir}}  <a class="btn btn-sm btn-primary" style="color:white" type="submit"
        href="" data-toggle="modal" data-target="#add"><i class="fas fa-eye"></i> Input Kinerja</a></h4> --}}
      ...
      <div class="table-responsive">
        <table class="display table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            $no = 1;
            @endphp
         @foreach($kinerja as $key => $items)
                <td>{{ $no++ }}</td>
                <td>{{ $items->kinerja}} </td>
                
                <td><a class="btn btn-sm btn-info" style="color:white" type="submit"
                    href="/inputkinerja/{{ $items->id }}"><i class="fas fa-eye"></i> Lihat Detail</a>
                                ...
                                <div class="col-lg-8">
                                    <table class="col-lg-12" id="dynamic_field">
                                        <tr>
                                            ...
                                            <td> <input value="{{$items->kinerja}}" readonly name="kinerja" type="text"  class="form-control"> </td>
