...
<div class="blog-container">
  ...
  <div class="blog-body">
    ...
    <div class="blog-title">
      ...
      href="" data-toggle="modal" data-target="#add"><i class="fas fa-eye"></i> Input Perilaku Kerja</a></h4><br>
      Nama : {{ $data->user->name}}
      <br>
      ...
      <div class="table-responsive" style="font-size:10px">
        <table style="font-size:12px" class="display table table-bordered" id="dataTable" width="100%" cellspacing="0">
         ...
         @foreach($dataz as $key => $items)
              <tr>
              <td>{{ $no++ }}</td>
              <td>{{$items->akhlak->akhlak}}</td> 
              <td>{{$items->ekspetasi}}</td> 
              <td>{{$items->umpan}}</td> 
            
              <td ><a class="btn btn-sm btn-info" style="color:white;font-size:10px" type="submit"
            ...
            <div class="modal-body">
              {{-- <div class="form-group row"><label class="col-lg-2 form-control-label">Intervensi </label>
                ...
                <select name="intervensi" id="intervensi" class="">
                    <option>Rencana Perilaku Kerja Atasan Langsung ({{$atasans}} )</option>
