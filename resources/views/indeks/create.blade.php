                ...
                <div class="page-content-wrapper">
                    <div class="content-wrapper container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">Buat indeks</div>
                                    <div class="card-body">
                                ...
                                <div class="panel panel-card margin-b-30">
                                    ...
                                    <div class="panel-body  p-xl-3">
                                        <form class="form-horizontal" action="{{ route('indeks.store') }}" method="post">
										{{ csrf_field() }}
                                            ...
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Judul</label>
