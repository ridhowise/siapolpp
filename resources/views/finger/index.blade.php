...
<div class="blog-container">
  ...
  <div class="blog-body">
    ...
    <div class="blog-title">
      <h6>Data Finger dari <b>{{$data->user->name}}</b></h6>
      <h6>Periode <b>{{$data->month->awal}} - {{$data->month->akhir}}</b></h6>
         ...
         @foreach($days as $key => $items)
            ...
            @endphp
                ...
                @endif
                  ...
                  @if($items->status == 1 or $items->status == 0) 
                  <td> - </td>
                  @else
                  <td> <a href="{{ url('data_file') }}/{{ $items->disiplin->file }}"
                    download="{{ $items->disiplin->file }}">
                ...
                <td><a class="btn btn-sm btn-success" style="color:white" type="submit"
                  href="/editfinger/{{ $items->id }}">Edit</a>
              ...
              <tr><td colspan="9"><b>TOTAL</b></td><td><b>{{$totals}} %</b></tr>
