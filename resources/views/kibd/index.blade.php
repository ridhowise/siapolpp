...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
            ...
            <h1 class="h3 mb-2 text-gray-800">KIB D <a href="{{ url('tahun/create') }}" class="btn btn-sm btn-primary"
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Rekap Tahunan KIB D </h6>
            </div>
            <div class="card-body">
        ...
        <div class="modal fade bd-example-modal-lg" id="adds" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" style="border:1px solid black;">
                    ...
                    <form id="upload-image-form" class="form-horizontal" action="{{ route('kibd.store') }}" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row"><label class="col-lg-3 form-control-label">Konstruksi</label>

                            <div class="col-lg-4">
                                <input type="text" name="konstruksi" placeholder="konstruksi" Barang" class="form-control" > 
                            </div>
                        </div>
                        <div class="form-group row"><label class="col-lg-3 form-control-label">Panjang</label>

                            <div class="col-lg-4">
                                <input type="text" name="panjang" placeholder="panjang" Barang" class="form-control" > 
                            </div>
                        </div>

                        <div class="form-group row"><label class="col-lg-3 form-control-label">Lebar</label>

                            <div class="col-lg-4">
                                <input type="text" name="lebar" placeholder="Lebar" Barang" class="form-control" > 
                            </div>
                        </div>
